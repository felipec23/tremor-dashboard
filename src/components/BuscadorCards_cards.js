...
export default function BuscadorCards() {
    const [selectedTerm, setSelectedTerm] = useState('Índice de pobreza multidimensional - IPM');
    ...
    return (
        ...
        <>
            ...
            <SelectBox defaultValue={'Índice de pobreza multidimensional - IPM'} onValueChange={(value) => {setSelectedTerm(value); filterData(value); getLinearData(value)}} on marginTop="mt-3" gapX='gap-x-6' gapY='gap-y-6'>
            ...
            <Text>En estas tarjetas se muestra el último dato registrado, el mínimo y el máximo histórico.</Text>
